...
resource
  .add('skyClear', './image/sprites/background/skyClear.png')
  .add('skyDark', './image/sprites/background/skyDark.png')
  .add('hill', './image/sprites/background/hill.png')
  .add('tree', './image/sprites/background/tree.png')
  .add('arrowKeys', './image/sprites/other/arrowKeys.png')
  .add('enterKey', './image/sprites/other/enterKey.png')
  .add('billboardSega', './image/sprites/other/billboard04.png')
  .add('startLights', './image/sprites/other/startLights.png')
  .add('startLightsBar', './image/sprites/other/startLightsBar.png')
  .add('leftSignal', './image/sprites/other/leftSignal.png')
  .add('rightSignal', './image/sprites/other/rightSignal.png')
  .add('opponents', './image/sprites/other/opponents.png')
  .add('playerLeft', './image/sprites/player/playerLeft.png')
  .add('playerRight', './image/sprites/player/playerRight.png')
